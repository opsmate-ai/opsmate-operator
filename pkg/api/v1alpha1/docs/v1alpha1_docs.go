...
const docTemplatev1alpha1 = `{
    ...
    "definitions": {
        ...
        "v1alpha1.EnvironmentBuildStatus": {
            ...
            "properties": {
                "taskCount": {
                    "description": "Number of tasks uses this environmentBuild",
                    "type": "integer"
                },
                "threadCount": {
                    "description": "Number of threads uses this environmentBuild",
                    "type": "integer"
                }
            }
        },
        "v1alpha1.Task": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha1.TaskSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha1.TaskStatus"
                }
            }
        },
        "v1alpha1.TaskSpec": {
        ...
        "v1alpha1.TaskStatus": {
            ...
            "properties": {
                "allocatedAt": {
                    "description": "The time when the task pod is up and running\n+optional",
                    "type": "string"
                },
                "conditions": {
                    "description": "The conditions of the task\n+optional",
                    "type": "array",
                    "items": {
                ...
                "ingress": {
                    "description": "Ingress is the reference to the ingress that is running the task\n+optional",
                    "allOf": [
                        {
                ...
                "internalIP": {
                    "description": "Internal IP of the Task Pod\n+optional",
                    "type": "string"
                },
                "output": {
                ...
                "pod": {
                    "description": "Pod is the reference to the pod that is running the task\n+optional",
                    "allOf": [
                        {
                            "$ref": "#/definitions/v1.ObjectReference"
                        }
                ...
                "service": {
                    "description": "Service is the reference to the service that is running the task\n+optional",
                    "allOf": [
                        {
                            "$ref": "#/definitions/v1.ObjectReference"
                        }
